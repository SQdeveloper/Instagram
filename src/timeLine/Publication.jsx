    ...
    return (
        <div className='publication'>
            <div className="publication_header">
                ...
                <svg aria-label="Más opciones" className="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24"><circle cx="12" cy="12" r="1.5"></circle><circle cx="6" cy="12" r="1.5"></circle><circle cx="18" cy="12" r="1.5"></circle></svg>
            </div>
            ...
            <div className="publication_reactions">
                <div className="publication_reactions-left">
                    ...
                    <button><svg aria-label="Comentar" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Comentar</title><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg></button>
            ...
            <div className="publication_post">
                <form action="" onSubmit={sendPost}>
                    <input ref={inputText} onChange={handleChangeInput} type="text" placeholder='Add a comment...' />
