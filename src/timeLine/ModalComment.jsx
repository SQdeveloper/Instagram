...
function ModalComment({likes, username, url}) {
    ...
    return (
        <div className='modal'>
            <div className="contentModal">
                <img className='contentModal_img' src="" alt="publication" />
                <div className="contentModal_info">
                    ...
                    <div className="contentModal_info-comments"></div>                    
                    ...
                    <div className="contentModal_info-post">
                        <form action="">                            
                            ...
                            <input className='contentModal_post-input' name='post' placeholder='Add a comment' type="text" />                            
                            <button>Post</button>
                        </form>
                    </div>
                </div>
