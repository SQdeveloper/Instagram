...
function Chat({listChat, identifier, listChatSelected, setListChat, username, name, imgPerfil}) {
    ...
    const handleForm = (e)=>{
        e.preventDefault();
        const newListSelected = [...listChatSelected];
        newListSelected.push(inputText.current.value);
        ...
        <>
            ...
            <div ref={sectionScroll} className="messages_sectionChat_scrollBar">
                <div className="messages_sectionChat-infoPerfil">
                    ...
                    <span className='messages_sectionChat-infoPerfil--username'>{username} • instagram</span>
                    <button className="messages_sectionChat-infoPerfil--buttonViewPerfil">
                        View Profile
                    </button>                
                </div>
                ...
                <div className="messages_sectionChat_conversation">
                    ...
                    }
                    {
                        ...
                        <div key={index} className="messages_sectionChat_conversation-message">
                            <span className="messages_sectionChat_conversation-message--text">
                                {ms}
                            </span>
                        </div>
                    ))}
            ...
            {/* <span>Se el primero en enviar un mensaje</span> */}
        </>
    );
}
